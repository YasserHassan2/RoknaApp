...
public class SliderAdapterExample extends
    ...
    private List<AdBanner> mSliderItems = new ArrayList<>();

    public SliderAdapterExample(Context context) {
        this.context = context;
    }

    public void renewItems(List<AdBanner> sliderItems) {
    ...
    public void addItem(AdBanner sliderItem) {
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, final int position) {
        ...
        AdBanner sliderItem = mSliderItems.get(position);
